...
Na tabela abaixo, é possível visualizar os trabalhos primários selecionados após aplicação dos critérios de inclusão e exclusão, e, para cada trabalho, a avaliação da qualidade, as técnicas de predição e de pré-processamento e as métricas utilizadas para validação dos modelos.
...
| :------------------------- | --------------------------------- | --------------------------------- | --------------------------------- | ------------ | ------------------------------------------------- | ----------------------------------------------- | ---------------------------------- |
| ~\citet{8639012}           | Alta                              | Alta                              | Alta                              | Alta         | Fuzzy-based CNN                                   | Normalização, Preenchimento de dados faltosos | MSE, MAE, RMSE                     |
| ~\citet{9345698}           | Alta                              | Alta                              | Alta                              | Alta         | CNN, LSTM                                         | Normalização                                  | MAPE, RMSE                         |
| ~\citet{Bao2021}           | Média                            | Média                            | Alta                              | Média       | DBN, SVR                                          | Normalização                                  | Accuracy, Mean Computing Time      |
| ~\citet{8846033}           | Alta                              | Média                            | Alta                              | Média       | CNN, GRU                                          | Não informado                                  | RMSE                               |
| ~\citet{8949498}           | Alta                              | Média                            | Média                            | Média       | PSO                                               | Correção de dados errôneos                   | MAPE, RMSE                         |
| ~\citet{9082612}           | Alta                              | Alta                              | Alta                              | Alta         | CNN, LSTM                                         | Wavelet Transform                               | MAPE, RMSE                         |
| ~\citet{Chen2019}          | Alta                              | Média                            | Alta                              | Média       | TFDC                                              | Normalização                                  | RMSE, MRE, MAE                     |
| ~\citet{8290688}           | Alta                              | Alta                              | Alta                              | Alta         | LSSVR                                             | Não informado                                  | RMSE                               |
| ~\citet{9393945}           | Alta                              | Média                            | Alta                              | Média       | LSTM                                              | Normalização, Remoção de dados anormais     | RMSE, MAE, MAPE                    |
| ~\citet{8854786}           | Alta                              | Alta                              | Alta                              | Alta         | CPPBTR                                            | Não informado                                  | MAPE, RMSE                         |
| ~\citet{8377977}           | Alta                              | Média                            | Alta                              | Média       | CNN, LSTM                                         | Não informado                                  | MSE, RMSE                          |
| ~\citet{8826268}           | Alta                              | Baixa                             | Baixa                             | Baixa        | Convolutional LSTM                                | Normalização                                  | MAPE, RMSE, MAE                    |
| ~\citet{8675737}           | Alta                              | Média                            | Alta                              | Média       | SVR, LSTM                                         | Não informado                                  | MAPE, RMSE, MAE                    |
| ~\citet{8786157}           | Alta                              | Média                            | Média                            | Média       | LSTM, GAV                                         | Não informado                                  | MAPE, RMSE                         |
| ~\citet{Jin2019}           | Alta                              | Média                            | Média                            | Média       | GRU                                               | Não informado                                  | RMSE, MRE, MAE                     |
| ~\citet{9146162}           | Alta                              | Alta                              | Alta                              | Alta         | STGAT                                             | Normalização                                  | MAE, RMSE, MAPE                    |
| ~\citet{9288672}           | Alta                              | Alta                              | Alta                              | Alta         | Fuzzy Comprehensive Evaluation, LSTM-SPRVM        | Normalização                                  | MAPE,     RMSE                     |
| ~\citet{8850005}           | Alta                              | Alta                              | Média                            | Média       | Densely CNN, LSTM                                 | Normalização                                  | RMSE                               |
| ~\citet{Li2021}            | Alta                              | Alta                              | Alta                              | Alta         | CNN, LSTM.                                        | Wavelet Transform, Normalização               | RMSE, MAE, R-square                |
| ~\citet{Liu2019}           | Alta                              | Média                            | Média                            | Média       | 3D-CNN, LSTM                                      | Normalização                                  | MPE, MER, PEV                      |
| ~\citet{8886396}           | Alta                              | Alta                              | Alta                              | Alta         | KELM                                              | Wavelet Transform                               | RMSE, MAPE, R square               |
| ~\citet{Ma2020}            | Alta                              | Alta                              | Alta                              | Alta         | CNN, LSTM                                         | Normalização                                  | MAE, RMSE, NSE, CORR               |
| ~\citet{8767922}           | Alta                              | Alta                              | Alta                              | Alta         | LSTM                                              | Normalização                                  | RMSE, MAPE                         |
| ~\citet{8382164}           | Alta                              | Média                            | Média                            | Média       | Stacked LSTM                                      | Normalização                                  | RMSE, MAE                          |
| ~\citet{9244097}           | Alta                              | Alta                              | Média                            | Alta         | NCAE, ELM                                         | Normalização                                  | MAPE, VAPE                         |
| ~\citet{9252095}           | Alta                              | Média                            | Alta                              | Média       | TCN                                               | Normalização                                  | MAE, MAPE, RMSE                    |
| ~\citet{8995482}           | Alta                              | Média                            | Alta                              | Alta         | Attention Neural Network (DNN-Attention), Deep FM | Não informado                                  | MAE, RMSE                          |
| ~\citet{Zang2019}          | Alta                              | Alta                              | Alta                              | Alta         | RDBDGN                                            | Normalização                                  | MRE, MAE, RMSE                     |
| ~\citet{Zhang2019}         | Média                            | Alta                              | Média                            | Média       | LSTM, K-means clustering                          | Não informado                                  | RMSE, MAE, R-square                |
| ~\citet{9080108}           | Alta                              | Alta                              | Alta                              | Alta         | MTL, GRU                                          | Normalização                                  | MAPE                               |
| ~\citet{Zhang2018}         | Alta                              | Alta                              | Alta                              | Alta         | SVR, GA, RF                                       | Normalização                                  | MAPE, RMSE                         |
| ~\citet{9082599}           | Média                            | Média                            | Média                            | Média       | RBM, SVR                                          | Normalização                                  | MAPE, RMSE                         |
| ~\citet{9093823}           | Alta                              | Alta                              | Alta                              | Alta         | LSTM                                              | AGACS                                           | MAE, MRE, RMSE                     |
| ~\citet{Zhao2020}          | Alta                              | Média                            | Média                            | Média       | SAEs, LSTM, GRU                                   | Imputação de dados ausentes                   | MAE, MRE, RMSE                     |
| ~\citet{8801840}           | Alta                              | Alta                              | Alta                              | Alta         | TCN                                               | Não informado                                  | MAE, MRE                           |
| ~\citet{9079512}           | Alta                              | Alta                              | Alta                              | Alta         | LSTM                                              | Normalização                                  | MAE, MAPE, RMSE                    |
| ~\citet{8853313}           | Alta                              | Média                            | Média                            | Média       | SVM, DBN                                          | Normalização                                  | MAPE, RMSE, MAE, MSE               |
| ~\citet{van2022comparison} | Alta                              | Alta                              | Alta                              | Alta         | TBATS, SARIMAX, LSTM                              | Não informado                                  | MAE                                |
| ~\citet{Feng2022}          | Alta                              | Alta                              | Alta                              | Alta         | GCN, GRU                                          | Normalização                                  | RMSE, MAE, Accuracy, R-square      |
| ~\citet{Reza2022}          | Alta                              | Alta                              | Alta                              | Alta         | Multi-head Attention-based Transformer            | Normalização                                  | MAPE, MSE                          |
| ~\citet{Buroni2021}        | Alta                              | Média                            | Alta                              | Média       | FNN, GCN, GRU                                     | Não informado                                  | RMSE, MAE, MASE                    |
| ~\citet{Chen2022}          | Alta                              | Média                            | Média                            | Média       | RF, GWN                                           | Não informado                                  | RMSE, MAE                          |
| ~\citet{Ruan2021}          | Alta                              | Alta                              | Alta                              | Alta         | LSTM                                              | Normalização                                  | RMSE, MAE                          |
| ~\citet{Zheng2022}         | Alta                              | Alta                              | Alta                              | Alta         | GCN, GAN                                          | Não informado                                  | MAE, MSE, RMSE                     |
| ~\citet{Nigam2023}         | Alta                              | Média                            | Alta                              | Média       | CNN, LSTM                                         | Normalização                                  | MAE, RMSE                          |
| ~\citet{Zhang2021}         | Alta                              | Média                            | Alta                              | Média       | CNN, GRU, Convolutional LSTM                      | Não informado                                  | MAPE, MAE, RMSE                    |
| ~\citet{Djenouri2023}      | Alta                              | Alta                              | Alta                              | Alta         | GCN, branch-and-bound                             | LOF                                             | mAP                                |
| ~\citet{Hussain2021}       | Alta                              | Alta                              | Alta                              | Alta         | GRU                                               | Não informado                                  | RMSE, MAPE, MAE                    |
| ~\citet{Li2021b}           | Alta                              | Alta                              | Alta                              | Alta         | DGCN                                              | Normalização                                  | MAE, MAPE, RMSE                    |
| ~\citet{Aljuaydi2022}      | Alta                              | Alta                              | Alta                              | Alta         | CNN, LSTM, Autoencoder LSTM                       | Normalização                                  | RMSE, MAE                          |
| ~\citet{Villarroya2022}    | Alta                              | Alta                              | Alta                              | Alta         | LSTM                                              | Não informado                                  | MAPE, sMAPE                        |
| ~\citet{menaoreja2021}     | Alta                              | Média                            | Alta                              | Média       | eRCNN                                             | Não informado                                  | MAE, MAPE, RMSE                    |
| ~\citet{Olayode2021}       | Alta                              | Alta                              | Alta                              | Alta         | RNA                                               | Não informado                                  | MAE, RMSE, R                       |
| ~\citet{Pranolo2022}       | Alta                              | Média                            | Média                            | Média       | LSTM, PSO, Bifold-Attention                       | Normalização                                  | MAPE, RMSE                         |
| ~\citet{Bilotta2022}       | Alta                              | Alta                              | Alta                              | Alta         | CONV-BI-LSTM                                      | Normalização                                  | MAE, MAPE, RMSE, MASE              |
...
Djenouri, Y., Belhadi, A., Srivastava, G., e Lin, J. C. W. (2023). Hybrid graph convolution neu-
...
Liu, R., Wang, Y., Zhou, H., e Qian, Z. (2019b). Short-Term Passenger Flow Prediction Based on
...
Zhang, J., Chen, F., e Shen, Q. (2019). Cluster-Based LSTM Network for Short-Term Passenger
